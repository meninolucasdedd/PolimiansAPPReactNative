...
export default class CadastroEspectadorFoto extends Component {
    ...
    renderBotaoUpload() {
        ...
        return <Button onPress={() => this.callUploadImage(this.state.imgSource.uri)}>
            Enviar
        </Button>
    }
                        ...
                        <ScrollView>
                            <Block flex middle>
                                <Block style={styles.loginContainer}>
                                    ...
                                    <Block bold middle>
                                        <Text h4 color="#442980" size={20} bold>Selecione uma foto:</Text>
                                    </Block>

                                    <Block middle >
                                        <Text p muted style={styles.texto}> Envie uma foto para seu perfil</Text>
                                    </Block>
                                    <Block middle flex>
                                        {
